...
{
    public class EconomicsAndGeoPoliticsPageViewModel : BaseViewModel
    {

        INavigation navigation;
        public EconomicsAndGeoPoliticsPageViewModel(INavigation navigation)
        {
        ...
        public async Task DoAction()
        {
            ...
            var apicall = await GECFAPI.Instance.GetCatNewsAsync(5);
