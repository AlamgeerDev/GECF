...
{
    public class HydrogenPageViewModel : BaseViewModel
    {

        INavigation navigation;
        public HydrogenPageViewModel(INavigation navigation)
        {
        ...
        public async Task DoAction()
        {
            ...
            var apicall = await GECFAPI.Instance.GetCatNewsAsync(15);
