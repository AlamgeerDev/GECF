...
public partial class AssetsAndInvestmentPage : ContentPage
{
    AssetsAndInvestmentPageViewModel vm;

    public AssetsAndInvestmentPage()
    {
        InitializeComponent();
        BindingContext = vm = new AssetsAndInvestmentPageViewModel(Navigation);
